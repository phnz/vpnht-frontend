...
(function() {
  "use strict";
  var StripeWebhook, User, api, dashboard, isAuthenticated, isUnauthenticated, mailgunApiTransport, main, moment, nodemailer, passwords, registrations, restify, secrets, sessions, setRedirect, setRender, stripeEvents, stripeWebhook, users;
  ...
  module.exports = function(app, passport) {
    ...
    app.get("/bitpay/redirect", setRedirect({
      auth: "/",
      success: "/dashboard"
    }), isAuthenticated, dashboard.getBitpayRedirect);
    return app.post("/bitpay/events", function(req, res, next) {
      var obj;
      obj = req.body;
